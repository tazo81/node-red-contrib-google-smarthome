...
class HttpActions {
    ...
    httpActionsRegister() {
        ...
        this.app.post('/', function(request, response) {
            ...
            me.debug('HttpActions:httpActionsRegister(/): request.headers = ' + JSON.stringify(request.headers));
            me.debug('HttpActions:httpActionsRegister(/): request.headers.authorization = ' + request.headers.authorization);
            me.debug('HttpActions:httpActionsRegister(/): reqdata = ' + JSON.stringify(reqdata));
            
            let res = request.headers.authorization.split(" ");
            if (res.length != 2 || res[0] != 'Bearer') {
                me.debug('HttpActions:httpActionsRegister(/): invalid authorization data; res = ' + JSON.stringify(res));
            ...
            if (!me.isValidAccessToken(accessToken)) {
                me.debug('HttpActions:httpActionsRegister(/): no accessToken found');
            ...
            if (!reqdata.inputs) {
                me.debug('HttpActions:httpActionsRegister(/): missing reqdata.inputs');
            ...
            for (let i = 0; i < reqdata.inputs.length; i++) {
                ...
                if (!intent) {
                    me.debug('HttpActions:httpActionsRegister(/): missing intent');
                ...
                switch (intent) {
                    case 'action.devices.SYNC':
                        me.debug('HttpActions:httpActionsRegister(/): SYNC');
                        /**
                         * request:
                         * {
                    ...
                    case 'action.devices.QUERY':
                        me.debug('HttpActions:httpActionsRegister(/): QUERY');
                        /**
                         * request:
                         * {
                         *   "requestId": "ff36a3cc-ec34-11e6-b1a0-64510650abcf",
                    ...
                    case 'action.devices.EXECUTE':
                        me.debug('HttpActions:httpActionsRegister(/): EXECUTE');
                        /**
                         * request:
                         * {
                         *   "requestId": "ff36a3cc-ec34-11e6-b1a0-64510650abcf",
                    ...
                    case 'action.devices.DISCONNECT':
                        me.debug('HttpActions:httpActionsRegister(/): DISCONNECT');
                    ...
                    default:
                        me.debug('HttpActions:httpActionsRegister(/): invalid intent');
         ...
         */
        this.app.options('/', function(request, response) {
            response.status(200).set({
                'Access-Control-Allow-Headers': 'Content-Type, Authorization',
            }).send('null');
        });
